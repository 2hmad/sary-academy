<table id="basic-datatable" class="table table-striped dt-responsive nowrap" width="100%">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <button type="button" class="btn btn-icon btn-secondary btn-sm" style="margin-right:5px;" onclick="confirmModal('<?php echo site_url('modal/popup/syllabus/assign_permission'); ?>')" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo get_phrase('assign_permission_for_teachers'); ?>"> <i class="dripicons-checklist"></i></button>
                <button type="button" class="btn btn-icon btn-secondary btn-sm" style="margin-right:5px;" onclick="rightModal('<?php echo site_url('modal/popup/teacher/update/'.$teacher['user_id']); ?>', '<?php echo get_phrase('update_teacher'); ?>')" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo get_phrase('update_teacher'); ?>"> <i class="mdi mdi-wrench"></i></button>
                <button type="button" class="btn btn-icon btn-secondary btn-sm" style="margin-right:5px;" onclick="confirmModal('<?php echo site_url('modal/popup/teacher/delete/'.$teacher['user_id']); ?>')" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo get_phrase('delete_teacher'); ?>"> <i class="mdi mdi-window-close"></i></button>
            </td>
        </tr>
        <?php } ?>
    </tbody>
