...
<form method="POST" class="col-12 d-block ajaxForm" action="<?php echo route('student/create_single_student'); ?>" id = "student_admission_form" enctype="multipart/form-data">
    <div class="col-md-12">
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-md-9">
            <textarea name="blood_group" id="blood_group" class="form-control"></textarea>
            </div>
        </div>
        ...
        <div class="form-group row mb-3">
            <label class="col-md-3 col-form-label" for="joiningpicker"><?php echo get_phrase('joining_date'); ?></label>
            <div class="col-md-9">
                <input type="text" class="form-control date" id="joiningpicker" data-toggle="date-picker" data-single-date-picker="true" name = "joining" value="<?php echo date('m/d/Y'); ?>" required>
            </div>
        </div>
