<div class="card">
  <div class="card-body">
    ...
    <div class="alert alert-warning" role="alert">
      <i class="dripicons-information mr-2"></i> <?php echo get_phrase('this_events_will_get_appeared_at'); ?> <strong><?php echo get_phrase('website'); ?> ( <?php echo get_phrase('frontend'); ?> ) <?php echo get_phrase('events'); ?></strong>.
    </div>
