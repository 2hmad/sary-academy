                ...
                <div class="card-body">
                    ...
                    <div class="text-center text-lg-left mb-3">
                        <a href="<?php echo site_url(); ?>">
                            <span><img src="<?php echo $this->settings_model->get_logo_dark(); ?>" alt="Sary Academy" style="width:250px"></span>
                        </a>
                    </div>
                    <!-- title-->
                    ...
                    <form action="<?php echo site_url('login/retrieve_password'); ?>" method="post" id="forgotForm" style="display: none;">
                        ...
                        <div class="form-group mb-0 text-center">
                            <button class="btn btn-primary btn-block" type="submit" style="background: darkorange!important;border-color: darkorange!important"><i class="mdi mdi-login"></i> <?php echo get_phrase('sent_password_reset_link'); ?> </button>
                        </div>
                    </form>
                    <!-- end form-->
                </div> <!-- end .card-body -->
